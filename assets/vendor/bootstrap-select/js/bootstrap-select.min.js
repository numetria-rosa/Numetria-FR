...
!(function (e, t) {
  ...
  !(function (z) {
    ...
    (i = null), String.prototype.startsWith ||
      ((t = (function () {
        try {
        ...
        : (String.prototype.startsWith = h)), Object.keys ||
    ...
    z.valHooks.select.set = function (e, t) {
      return t && !p.useDefault && z (e).data ('selected', !0), p._set.apply (
        this,
        arguments
      );
    };
    ...
    function k (e, t, i, s) {
      for (
        ...
        if (
          a &&
          ((a = a.toString ()), 'display' === l &&
            (a = a.replace (/<[^>]+>/g, '')), s &&
            (a = w (a)), (a = a.toUpperCase ()), (o = 'contains' === i
            ? 0 <= a.indexOf (t)
            : a.startsWith (t)))
        )
          break;
    ...
    z.fn.triggerNative = function (e) {
      ...
      i.dispatchEvent
        ...
        : i.fireEvent
            ? (((t = document.createEventObject ()).eventType = e), i.fireEvent (
                'on' + e,
                t
              ))
            : this.trigger (e);
    ...
    var I,
      ...
      S = ((I = {
        ...
        "'": '&#x27;',
        '`': '&#x60;',
      }), (x = '(?:' + Object.keys (I).join ('|') + ')'), (y = RegExp (
        x
      )), ($ = RegExp (x, 'g')), function (e) {
    ...
    try {
      (R.full = (z.fn.dropdown.Constructor.VERSION || '')
        .split (' ')[0]
        .split ('.')), (R.major = R.full[0]), (R.success = !0);
    } catch (e) {}
    var U = 0,
      j = '.bs.select',
      V = {
    ...
    _.a.setAttribute (
      'role',
      'option'
    ), '4' === R.major && (_.a.className = 'dropdown-item'), (_.subtext.className = 'text-muted'), (_.text = _.span.cloneNode (!1)), (_.text.className = 'text'), (_.checkMark = _.span.cloneNode (!1));
    var G = new RegExp (B + '|' + M),
      ...
      K = {
        li: function (e, t, i) {
          ...
          return e &&
            ...
            '' !== t &&
            (s.className = t), null != i &&
            s.classList.add ('optgroup-' + i), s;
        },
        a: function (e, t, i) {
          ...
          return e &&
            ...
            '' !== t &&
            s.classList.add.apply (s.classList, t.split (' ')), i &&
          ...
          if (e.content) n.innerHTML = e.content;
            ...
            if (((n.textContent = e.text), e.icon)) {
              ...
              ((s = (!0 === t ? _.i : _.span).cloneNode (!1)).className =
                this.options.iconBase + ' ' + e.icon), _.fragment.appendChild (
                s
              ), _.fragment.appendChild (o);
            }
            e.subtext &&
              (((i = _.subtext.cloneNode (!1)).textContent =
                e.subtext), n.appendChild (i));
          }
          if (!0 === t)
        ...
        label: function (e) {
          ...
          return e.subtext &&
            (((t = _.subtext.cloneNode (!1)).textContent =
              e.subtext), s.appendChild (t)), _.fragment.appendChild (
            s
          ), _.fragment;
        },
      },
      Y = function (e, t) {
        var i = this;
        p.useDefault ||
          ((z.valHooks.select.set =
            p._set), (p.useDefault = !0)), (this.$element = z (
          e
        ...
        }), (this.sizeInfo = {}), null === this.options.title &&
          (this.options.title = this.$element.attr ('title'));
        var s = this.options.windowPadding;
        'number' == typeof s &&
          (this.options.windowPadding = [s, s, s, s]), (this.val =
          Y.prototype.val), (this.render = Y.prototype.render), (this.refresh =
          Y.prototype.refresh), (this.setStyle =
          Y.prototype.setStyle), (this.selectAll =
          Y.prototype.selectAll), (this.deselectAll =
          Y.prototype.deselectAll), (this.destroy =
          Y.prototype.destroy), (this.remove = Y.prototype.remove), (this.show =
          Y.prototype.show), (this.hide = Y.prototype.hide), this.init ();
      };
    function Z (e) {
      ...
      if (([].shift.apply (a), !R.success)) {
        try {
          ...
          Y.BootstrapVersion
            ...
            : ((R.full = [R.major, '0', '0']), console.warn (
      ...
      if ('4' === R.major) {
        ...
        Y.DEFAULTS.style === V.BUTTONCLASS &&
          t.push ({name: 'style', className: 'BUTTONCLASS'}), Y.DEFAULTS
          .iconBase === V.ICONBASE &&
          t.push ({name: 'iconBase', className: 'ICONBASE'}), Y.DEFAULTS
          .tickIcon === V.TICKICON &&
          t.push ({name: 'tickIcon', className: 'TICKICON'}), (V.DIVIDER =
          'dropdown-divider'), (V.SHOW = 'show'), (V.BUTTONCLASS =
          'btn-light'), (V.POPOVERHEADER = 'popover-header'), (V.ICONBASE =
    ...
    (Y.VERSION = '1.13.14'), (Y.DEFAULTS = {
      ...
      init: function () {
        ...
        U++, (this.selectId =
          'bs-select-' + U), this.$element[0].classList.add (
          'bs-select-hidden'
          ...
          (this.options.showTick = !0), (this.$newElement = this.createDropdown ()), this.buildData (), this.$element
          ...
          'input'
        )), this.$element[0].classList.remove ('bs-select-hidden'), !0 ===
          this.options.dropdownAlignRight &&
          this.$menu[0].classList.add (V.MENURIGHT), void 0 !== e &&
          this.$button.attr (
            'data-id',
            e
          ...
          : (this.focusedParent = this.$menuInner[0]), this.setStyle (), this.render (), this.setWidth (), this
          .options.container
          ? this.selectPosition ()
          ...
          this.$element.on ('invalid' + j, function () {
            i.$button[0].classList.add ('bs-invalid'), i.$element
              ...
              i.$element
                .trigger ('focus')
                .trigger ('blur'), i.$button.off ('blur' + j);
            });
          }), setTimeout (function () {
        ...
        for (
          ...
          'divider' === t.type
            ...
            (this.selectpicker.view
              .size++, (t.posinset = this.selectpicker.view.size)), (t.position =
      ...
      createView: function (A, e, t) {
        ...
        if (
          ((this.selectpicker.isSearching = A), (this.selectpicker.current = A
        ...
        function l (e, t) {
          var i,
            ...
            p = !0,
            u = D.isVirtual ();
          (D.selectpicker.view.scrollTop = e), (i = Math.ceil (
          ...
          if (
            (void 0 === r && (r = 0), (l = [
            ...
            ]), (n = Math.max (0, r - 1)), (o = Math.min (
              s - 1,
              r + 1
            )), (D.selectpicker.view.position0 = !1 === u
              ? 0
              : Math.max (0, h[n][0]) ||
                  0), (D.selectpicker.view.position1 = !1 === u
              ? d
              : Math.min (d, h[o][1]) || 0), (a =
              l[0] !== D.selectpicker.view.position0 ||
              l[1] !== D.selectpicker.view.position1), void 0 !==
              D.activeIndex &&
              ((N = D.selectpicker.main.elements[D.prevActiveIndex]), (H =
                D.selectpicker.main.elements[D.activeIndex]), (L =
                D.selectpicker.main.elements[D.selectedIndex]), t &&
                (D.activeIndex !== D.selectedIndex &&
                  D.defocusItem (H), (D.activeIndex = void 0)), D.activeIndex &&
                D.activeIndex !== D.selectedIndex &&
                D.defocusItem (L)), void 0 !== D.prevActiveIndex &&
              ...
              ((c = D.selectpicker.view.visibleElements
                ...
                }) (c, D.selectpicker.view.visibleElements)), (t || !0 === u) &&
                p))
          ) {
            var v,
              g,
            ...
            if (
              (D.options.sanitize &&
                k.length &&
                P (k, D.options.whiteList, D.options.sanitizeFn), !0 === u
                ? ((v = 0 === D.selectpicker.view.position0
                    ? 0
                    : D.selectpicker.current.data[
                        D.selectpicker.view.position0 - 1
                      ].position), (g = D.selectpicker.view.position1 > d - 1
                    ? 0
                    : D.selectpicker.current.data[d - 1].position -
                        D.selectpicker.current.data[
                          D.selectpicker.view.position1 - 1
                        ].position), (b.firstChild.style.marginTop =
                    v + 'px'), (b.firstChild.style.marginBottom = g + 'px'))
                : ((b.firstChild.style.marginTop = 0), (b.firstChild.style.marginBottom = 0)), b.firstChild.appendChild (
                w
              ...
              if (
                ...
                O > D.sizeInfo.menuInnerInnerWidth &&
                  ((D.sizeInfo.menuInnerInnerWidth = O), (b.firstChild.style.minWidth =
                    D.sizeInfo.menuInnerInnerWidth +
                    'px')), (D.$menu[0].style.minWidth = '');
              }
            }
          }
          if (((D.prevActiveIndex = D.activeIndex), D.options.liveSearch)) {
            if (A && t) {
              ...
              D.selectpicker.view.canHighlight[T] ||
                (T =
                  1 +
                  D.selectpicker.view.canHighlight.slice (1).indexOf (!0)), (z =
                D.selectpicker.view.visibleElements[T]), D.defocusItem (
                D.selectpicker.view.currentActive
              ), (D.activeIndex = (D.selectpicker.current.data[
                T
              ] || {}).index), D.focusItem (z);
            }
          } else D.$menuInner.trigger ('focus');
        }
        l (i, !0), this.$menuInner
        ...
        if (this.options.title && !this.multiple) {
          ...
          if (s)
            (this.selectpicker.view.titleOption.className =
              'bs-title-option'), (this.selectpicker.view.titleOption.value =
              ''), (i =
      ...
      buildData: function () {
        ...
        function v (e, t) {
          if (
            (((t = t || {}).divider =
              'true' === e.getAttribute ('data-divider')), t.divider)
          )
            m ({optID: t.optID});
          else {
            var i = u.length,
            ...
            t.optID &&
              (o =
                'opt ' +
                o), (t.optionClass = o.trim ()), (t.inlineStyle = n), (t.text =
              e.textContent), (t.content = e.getAttribute (
              'data-content'
            )), (t.tokens = e.getAttribute (
              'data-tokens'
            )), (t.subtext = e.getAttribute (
              'data-subtext'
            )), (t.icon = e.getAttribute (
              'data-icon'
            )), (e.liIndex = i), (t.display = t.content || t.text), (t.type =
              'option'), (t.index = i), (t.option = e), (t.selected = !!e.selected), (t.disabled =
              t.disabled || !!e.disabled), u.push (t);
          }
        }
        function i (e, t) {
          var i = t[e],
      ...
      buildList: function () {
        ...
        function t (e) {
          ...
          n.push (t), e.display && (i += e.display.length), e.subtext &&
            (i += e.subtext.length), e.icon && (i += 1), o < i &&
        ...
        (!s.options.showTick && !s.multiple) ||
          ...
          ((_.checkMark.className =
            ...
            ' ' +
            s.options.tickIcon +
            ' check-mark'), _.a.appendChild (_.checkMark));
      ...
      render: function () {
        ...
        if (
          (r.classList.toggle (
            'bs-placeholder',
            t.multiple ? !o : !T (i, n)
          ), this.tabIndex (), 'static' === this.options.selectedTextFormat)
        )
          ...
          if (!s) {
            for (var h = 0; h < o && h < 50; h++) {
              ...
              this.multiple &&
                0 < h &&
                c.appendChild (a.cloneNode (!1)), p.title
                ? (f.text = p.title)
                : u &&
                    (u.content && t.options.showContent
                      ? ((f.content = u.content.toString ()), (d = !0))
                      : (t.options.showIcon && (f.icon = u.icon), t.options
                          .showSubtext &&
                          !t.multiple &&
                          u.subtext &&
                          (f.subtext =
                            ' ' +
                            u.subtext), (f.text = p.textContent.trim ()))), c.appendChild (
                K.text.call (this, f, !0)
              );
            }
        ...
        if (
          (null == this.options.title &&
            (this.options.title = this.$element.attr ('title')), c.childNodes
            .length ||
            (c = K.text.call (
              this,
              {
                text: void 0 !== this.options.title
                  ? this.options.title
            ...
            .replace (/<[^>]*>?/g, '')
            .trim ()), this.options.sanitize &&
            d &&
            P ([c], t.options.whiteList, t.options.sanitizeFn), (l.innerHTML =
            ''), l.appendChild (c), R.major < 4 &&
            this.$newElement[0].classList.contains ('bs3-has-addon'))
        ) {
          var b = r.querySelector ('.filter-expand'), w = l.cloneNode (!0);
          (w.className = 'filter-expand'), b
            ? r.replaceChild (w, b)
            : r.appendChild (w);
        }
      ...
      setStyle: function (e, t) {
        ...
        this.$element.attr ('class') &&
          ...
          (n.classList.add ('bs3'), n.parentNode.classList.contains (
            'input-group'
          ) &&
            ...
            n.classList.add ('bs3-has-addon')), (i = e
          ? e.trim ()
          : o), 'add' == t
          ...
          : 'remove' == t
              ...
              : (o &&
                  s.classList.remove.apply (s.classList, o.split (' ')), i &&
      ...
      liHeight: function (e) {
        if (
          ...
          if (
            ((this.sizeInfo.selectWidth = this.$newElement[0].offsetWidth), (c.className =
              'text'), (a.className =
              'dropdown-item ' + (f ? f.className : '')), (t.className =
              this.$menu[0].parentNode.className +
              ' ' +
              V.SHOW), (t.style.width = 0), 'auto' === this.options.width &&
              (i.style.minWidth = 0), (i.className =
              V.MENU + ' ' + V.SHOW), (s.className =
              'inner ' + V.SHOW), (n.className =
              V.MENU +
              ' inner ' +
              ('4' === R.major ? V.SHOW : '')), (o.className =
              V.DIVIDER), (r.className = 'dropdown-header'), c.appendChild (
              document.createTextNode ('\u200b')
            ), a.appendChild (c), l.appendChild (a), r.appendChild (
              c.cloneNode (!0)
            ), this.selectpicker.view.widestOption &&
              n.appendChild (
                this.selectpicker.view.widestOption.cloneNode (!0)
              ), n.appendChild (l), n.appendChild (o), n.appendChild (r), d &&
              i.appendChild (d), h)
          ) {
            var m = document.createElement ('input');
            (h.className = 'bs-searchbox'), (m.className =
              'form-control'), h.appendChild (m), i.appendChild (h);
          }
          p && i.appendChild (p), s.appendChild (n), i.appendChild (s), u &&
            i.appendChild (u), t.appendChild (i), document.body.appendChild (t);
          var v,
            g = l.offsetHeight,
          ...
          (s.style.overflowY = 'scroll'), (v =
            i.offsetWidth - S), document.body.removeChild (
            t
          ), (this.sizeInfo.liHeight = g), (this.sizeInfo.dropdownHeaderHeight = b), (this.sizeInfo.headerHeight = w), (this.sizeInfo.searchHeight = I), (this.sizeInfo.actionsHeight = x), (this.sizeInfo.doneButtonHeight = k), (this.sizeInfo.dividerHeight = y), (this.sizeInfo.menuPadding = C), (this.sizeInfo.menuExtras = O), (this.sizeInfo.menuWidth = S), (this.sizeInfo.menuInnerInnerWidth =
            S -
            C.horiz), (this.sizeInfo.totalMenuWidth = this.sizeInfo.menuWidth), (this.sizeInfo.scrollBarWidth = v), (this.sizeInfo.selectHeight = this.$newElement[0].offsetHeight), this.setPositionData ();
        }
      },
      ...
      setMenuSize: function (e) {
        ...
        if (
          (this.options.dropupAuto &&
            ((l = d * this.selectpicker.current.elements.length + v.vert), (a =
              ...
              l + this.sizeInfo.menuExtras.vert + 50 >
                this.sizeInfo.selectOffsetBot), !0 ===
              this.selectpicker.isSearching &&
              (a = this.selectpicker.dropup), this.$newElement.toggleClass (
              V.DROPUP,
              a
            ), (this.selectpicker.dropup = a)), 'auto' === this.options.size)
        )
          (n = 3 < this.selectpicker.current.elements.length
            ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2
            : 0), (i =
            this.sizeInfo.selectOffsetBot - this.sizeInfo.menuExtras.vert), (s =
            n + h + p + u + f), (r = Math.max (
            n - v.vert,
            0
        ...
        this.$menu.css ({
          ...
          ((this.sizeInfo.hasScrollBar = !0), (this.sizeInfo.totalMenuWidth =
            this.sizeInfo.menuWidth + this.sizeInfo.scrollBarWidth)), 'auto' ===
          this.options.dropdownAlignRight &&
      ...
      setSize: function (e) {
        if (
          (this.liHeight (e), this.options.header &&
            this.$menu.css ('padding-top', 0), !1 !== this.options.size)
        ) {
        ...
        function e (e) {
          ...
          r.$bsContainer
            ...
            .toggleClass (
              V.DROPUP,
              e.hasClass (V.DROPUP)
            ), (s = e.offset ()), l.is ('body')
            ? (n = {top: 0, left: 0})
            : (((n = l.offset ()).top +=
                parseInt (l.css ('borderTopWidth')) -
                l.scrollTop ()), (n.left +=
                parseInt (l.css ('borderLeftWidth')) -
                l.scrollLeft ())), (o = e.hasClass (V.DROPUP)
            ? 0
            : e[0].offsetHeight), (R.major < 4 || 'static' === i) &&
            ((t.top = s.top - n.top + o), (t.left =
              s.left - n.left)), (t.width =
            e[0].offsetWidth), r.$bsContainer.css (t);
        }
        var s, n, o, r = this, l = z (this.options.container);
        this.$button.on ('click.bs.dropdown.data-api', function () {
          r.isDisabled () ||
            (e (r.$newElement), r.$bsContainer
      ...
      setOptionStatus: function (e) {
        var t = this;
        if (
          ((t.noScroll = !1), t.selectpicker.view.visibleElements &&
          ...
          for (var i = 0; i < t.selectpicker.view.visibleElements.length; i++) {
            var s =
              ...
              n = s.option;
            n &&
              (!0 !== e && t.setDisabled (s.index, s.disabled), t.setSelected (
                s.index,
                n.selected
              ));
          }
      ...
      setSelected: function (e, t) {
        ...
        (o.selected = t), (s = n.firstChild), t &&
          (this.selectedIndex = e), n.classList.toggle ('selected', t), l
          ? (this.focusItem (
              n,
              o
            ), (this.selectpicker.view.currentActive = n), (this.activeIndex = e))
          : this.defocusItem (n), s &&
          (s.classList.toggle ('selected', t), t
            ? s.setAttribute ('aria-selected', !0)
            : this.multiple
                ? s.setAttribute ('aria-selected', !1)
                : s.removeAttribute ('aria-selected')), l ||
          r ||
          !t ||
      ...
      setDisabled: function (e, t) {
        ...
        (this.selectpicker.main.data[e].disabled = t), (i =
          s.firstChild), s.classList.toggle (V.DISABLED, t), i &&
          ('4' === R.major && i.classList.toggle (V.DISABLED, t), t
            ? (i.setAttribute ('aria-disabled', t), i.setAttribute (
                'tabindex',
                -1
              ))
            : (i.removeAttribute ('aria-disabled'), i.setAttribute (
                'tabindex',
                0
              )));
      },
      ...
      clickListener: function () {
        ...
        t.data ('spaceSelect', !1), this.$button.on ('keyup', function (e) {
          ...
          3 < R.major &&
            !C.dropdown &&
            ((C.dropdown = C.$button.data ('bs.dropdown')), (C.dropdown._menu =
              C.$menu[0]));
        }), this.$button.on ('click.bs.dropdown.data-api', function () {
          ...
          C.$menuInner[0].scrollTop !== C.selectpicker.view.scrollTop &&
            (C.$menuInner[0].scrollTop =
              C.selectpicker.view.scrollTop), 3 < R.major ? requestAnimationFrame (i) : e ();
          ...
          if (
            (C.multiple &&
              ...
              e.stopPropagation (), e.preventDefault (), !C.isDisabled () &&
            ...
            if (
              (r === C.activeIndex && (t = !0), t ||
                ((C.prevActiveIndex =
                  C.activeIndex), (C.activeIndex = void 0)), C.multiple)
            ) {
              if (
                ((h.selected = !u), C.setSelected (r, !u), i.trigger (
                  'blur'
                ), !1 !== v || !1 !== g)
              ) {
                var b = v < O (s).length,
                ...
                if ((v && b) || (g && w))
                  if (v && 1 == v)
                    (s.selectedIndex = -1), (h.selected = !0), C.setOptionStatus (
                      !0
                    );
                  else if (g && 1 == g) {
                    ...
                    y[2] &&
                      (($ = $.replace (
                        ...
                        '{var}',
                        y[2][1 < g ? 0 : 1]
                      ))), (h.selected = !1), C.$menu.append (E), v &&
                      b &&
                      (E.append (
                        z ('<div>' + $ + '</div>')
                      ), (d = !1), C.$element.trigger ('maxReached' + j)), g &&
                      w &&
                      (E.append (
                        z ('<div>' + S + '</div>')
                      ), (d = !1), C.$element.trigger (
                        'maxReachedGrp' + j
                      )), setTimeout (function () {
                      C.setSelected (r, !1);
                    }, 10), E[0].classList.add (
                      'fadeOut'
                    ), setTimeout (function () {
                      E.remove ();
                    }, 1050);
              ...
              c && (c.selected = !1), (h.selected = !0), C.setSelected (r, !0);
            !C.multiple || (C.multiple && 1 === C.options.maxOptions)
              ? C.$button.trigger ('focus')
              : C.options.liveSearch && C.$searchbox.trigger ('focus'), d &&
          ...
          function (e) {
            e.currentTarget == this &&
              (e.preventDefault (), e.stopPropagation (), C.options
                .liveSearch && !z (e.target).hasClass ('close')
                ? C.$searchbox.trigger ('focus')
                : C.$button.trigger ('focus'));
          }
          ...
          e.preventDefault (), e.stopPropagation (), C.options.liveSearch
            ? C.$searchbox.trigger ('focus')
            : C.$button.trigger ('focus');
        }), this.$menu.on (
          'click',
          ...
          C.options.liveSearch
            ...
            : C.$button.trigger (
                'focus'
              ), e.preventDefault (), e.stopPropagation (), z (this).hasClass ('bs-select-all') ? C.selectAll () : C.deselectAll ();
        }), this.$element
        ...
        this.$button.on ('click.bs.dropdown.data-api', function () {
          ...
          if (
            ...
            for (var l = 0; l < u.selectpicker.main.data.length; l++) {
              ...
              s[l] || (s[l] = k (a, i, o, r)), s[l] &&
                void 0 !== a.headerIndex &&
                -1 === n.indexOf (a.headerIndex) &&
                (0 < a.headerIndex &&
                  ((s[a.headerIndex - 1] = !0), n.push (a.headerIndex - 1)), (s[
                  a.headerIndex
                ] = !0), n.push (a.headerIndex), (s[a.lastIndex + 1] = !0)), s[
                l
              ] &&
            ...
            for (var c = n.length; l < c; l++) {
              var d = n[l],
                h = n[l - 1],
                p = ((a = u.selectpicker.main.data[d]), u.selectpicker.main
                  .data[h]);
              ('divider' !== a.type ||
                ('divider' === a.type &&
                  p &&
                  'divider' !== p.type &&
                  c - 1 !== l)) &&
                (u.selectpicker.search.data.push (a), t.push (
                  u.selectpicker.main.elements[d]
                ));
            }
            (u.activeIndex = void 0), (u.noScroll = !0), u.$menuInner.scrollTop (
              0
            ), (u.selectpicker.search.elements = t), u.createView (
              !0
            ), t.length ||
              ((f.className =
                'no-results'), (f.innerHTML = u.options.noneResultsText.replace (
                '{0}',
                '"' + S (e) + '"'
      ...
      val: function (e) {
        ...
        var i = T (t);
        if (
          ((A = [null, null, i]), this.$element
            .val (e)
            .trigger ('changed' + j, A), this.$newElement.hasClass (V.SHOW))
        )
          if (this.multiple) this.setOptionStatus (!0);
          else {
            var s = (t.options[t.selectedIndex] || {}).liIndex;
            'number' == typeof s &&
              (this.setSelected (this.selectedIndex, !1), this.setSelected (
                s,
                !0
              ));
          }
      ...
      keydown: function (e) {
        ...
        if (!(112 <= e.which && e.which <= 123))
          if (
            ...
            (a.$button.trigger ('click.bs.dropdown.data-api'), a.options
              .liveSearch)
          )
            ...
            if (
              ...
              -1 !==
                (t = (s = a.selectpicker.main.elements[a.activeIndex])
                  ...
                  : -1) && a.defocusItem (s), e.which === B
                ? (-1 !== t && t--, t + f < 0 && (t += c.length), a.selectpicker
                    .view.canHighlight[t + f] ||
                    (-1 ===
                      (t =
                ...
                : (e.which !== M && !h) ||
                    (++t + f >= a.selectpicker.view.canHighlight.length &&
                      (t = 0), a.selectpicker.view.canHighlight[t + f] ||
                      (t =
                        t +
                        1 +
                        a.selectpicker.view.canHighlight
                          .slice (t + f + 1)
                          .indexOf (!0))), e.preventDefault ();
              var m = f + t;
              e.which === B
                ? 0 === f && t === c.length - 1
                    ? ((a.$menuInner[0].scrollTop =
                        a.$menuInner[0].scrollHeight), (m =
              ...
              e.preventDefault (), (a.selectpicker.keydown.keyHistory +=
                C[e.which]), a.selectpicker.keydown.resetKeyHistory.cancel &&
                clearTimeout (
              ...
              if (b.length) {
                ...
                c
                  .removeClass ('active')
                  .find ('a')
                  .removeClass ('active'), 1 === g.length &&
                  (-1 === (x = b.indexOf (a.activeIndex)) || x === b.length - 1
                    ? (x = 0)
                    : x++), (v = b[x]), (d = 0 <
                  u - (n = a.selectpicker.main.data[v]).position
                  ? ((o = n.position - n.height), !0)
                  : ((o = n.position - a.sizeInfo.menuInnerHeight), n.position >
                      u + a.sizeInfo.menuInnerHeight)), (s =
                  a.selectpicker.main.elements[v]), (a.activeIndex =
                  b[x]), a.focusItem (s), s && s.firstChild.focus (), d &&
                  (a.$menuInner[0].scrollTop = o), r.trigger ('focus');
              }
            }
            i &&
              ((e.which === H && !a.selectpicker.keydown.keyHistory) ||
              ...
              (e.which !== H && e.preventDefault (), (a.options.liveSearch &&
                e.which === H) ||
                (a.$menuInner
                  .find ('.active a')
                  .trigger ('click', !0), r.trigger ('focus'), a.options
                  .liveSearch ||
                  (e.preventDefault (), z (document).data (
                    'spaceSelect',
                    !0
                  ))));
          }
      ...
      refresh: function () {
        ...
        (this.options = e), this.checkDisabled (), this.setStyle (), this.render (), this.buildData (), this.buildList (), this.setWidth (), this.setSize (
          !0
      ...
      destroy: function () {
        this.$newElement.before (this.$element).remove (), this.$bsContainer
          ...
          .removeClass ('bs-select-hidden selectpicker'), z (window).off (
          j + '.' + this.selectId
        );
      },
    });
