...
!(function (t) {
  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof exports
        ? ((n = require ('jquery')), (o = function (e, a) {
            a.fn.dataTable || require ('datatables.net') (e, a);
          }), 'undefined' == typeof window
            ? (module.exports = function (e, a) {
                return (e = e || window), (a = a || n (e)), o (e, a), t (
                  a,
                  0,
                  e.document
                );
              })
            : (o (window, n), (module.exports = t (
                n,
                window,
                window.document
              ))))
  ...
  return x.extend (!0, r.defaults, {
    ...
    renderer: 'bootstrap',
  }), x.extend (r.ext.classes, {sWrapper: 'dataTables_wrapper dt-bootstrap4', sFilterInput: 'form-control form-control-sm', sLengthSelect: 'custom-select custom-select-sm form-control form-control-sm', sProcessing: 'dataTables_processing card', sPageButton: 'paginate_button page-item'}), (r.ext.renderer.pageButton.bootstrap = function (
    i,
    e,
    d,
    a,
    ...
    function u (e, a) {
      for (
        var t,
          n,
          o = function (e) {
            e.preventDefault (), x (e.currentTarget).hasClass ('disabled') ||
        ...
        if (((t = a[r]), Array.isArray (t))) u (e, t);
          ...
          p &&
            ((n = -1 !== f.indexOf ('disabled')), (n = x ('<li>', {
              ...
              .appendTo (e)), i.oApi._fnBindAction (n, {action: t}, o));
        }
    }
    var p,
      f,
    ...
    u (
      x (e).empty ().html ('<ul class="pagination"/>').children ('ul'),
      a
    ), t !== o && x (e).find ('[data-dt-idx=' + t + ']').trigger ('focus');
  }), r;
});
