...
!(function (n) {
  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof exports
        ? ((r = require ('jquery')), (a = function (t, e) {
            e.fn.dataTable || require ('datatables.net') (t, e), e.fn.dataTable
              .Buttons || require ('datatables.net-buttons') (t, e);
          }), 'undefined' == typeof window
            ? (module.exports = function (t, e, o, l) {
                return (t = t || window), (e = e || r (t)), a (t, e), n (
                  e,
                  t,
                  t.document
                );
              })
            : (a (window, r), (module.exports = n (
                r,
                window,
                window.document
              ))))
  ...
  var O = (function (d) {
    ...
    if (
      ...
      return (t = d.document), (p = function () {
      ...
      }), (i = t.createElementNS ('http://www.w3.org/1999/xhtml', 'a')), (s =
        'download' in i), (f =
        /constructor/i.test (d.HTMLElement) ||
        d.safari), (m = /CriOS\/[\d]+/.test (
        navigator.userAgent
      )), (y = function (t) {
        ...
        (r.readyState = r.INIT), s
          ? ((l = p ().createObjectURL (t)), setTimeout (function () {
              var t, e;
          ...
          : (m || (e && f)) && d.FileReader
              ? (((n = new FileReader ()).onloadend = function () {
                  ...
                  d.open (t, '_blank') ||
                    (d.location.href = t), (t = k), (r.readyState =
                    r.DONE), a ();
                }), n.readAsDataURL (t), (r.readyState = r.INIT))
              : ((l = l || p ().createObjectURL (t)), (!e &&
                  d.open (l, '_blank')) ||
                  (d.location.href = l), (r.readyState = r.DONE), a (), u (l));
      }).prototype), 'undefined' != typeof navigator &&
        navigator.msSaveOrOpenBlob
        ? function (t, e, o) {
            return (e = e || t.name || 'download'), o ||
              (t = c (t)), navigator.msSaveOrOpenBlob (t, e);
          }
        : ((t.abort = function () {}), (t.readyState = t.INIT = 0), (t.WRITING = 1), (t.DONE = 2), (t.error = t.onwritestart = t.onprogress = t.onwrite = t.onabort = t.onerror = t.onwriteend = null), function (
            t,
            e,
            o
          ) {
  ...
  function E (t, e, o) {
    ...
    return o &&
      (o.attr && C (l).attr (o.attr), o.children &&
        C.each (o.children, function (t, e) {
          l.appendChild (e);
        }), null !== o.text &&
        o.text !== k &&
        l.appendChild (t.createTextNode (o.text))), l;
  }
  var _ = {
  ...
  return (n.ext.buttons.copyHtml5 = {
    ...
    action: function (t, e, o, l) {
      ...
      var n = this,
        ...
        d = (a.title && (p = a.title + d + d + p), a.messageTop &&
          (p = a.messageTop + d + d + p), a.messageBottom &&
          (p = p + d + d + a.messageBottom), l.customize &&
          (p = l.customize (p, l, e)), C ('<textarea readonly/>')
          .val (p)
          .appendTo (i));
      ...
      function f () {
        m.off ('click.buttons-copy'), C (y).off (
          '.buttons-copy'
        ), e.buttons.info (!1);
      }
      var a = C (
        ...
        m = (e.buttons.info (
          ...
          a,
          0
        ), d[0].focus (), d[0].select (), C (a).closest ('.dt-button-info'));
      m.on ('click.buttons-copy', f), C (y)
    ...
    action: function (t, e, o, l) {
      ...
      l.customize && (n = l.customize (n, l, e)), (a = !1 !== a
        ? (a = a || y.characterSet || y.charset) && ';charset=' + a
        : ''), l.bom && (n = String.fromCharCode (65279) + n), O (
        new Blob ([n], {type: 'text/csv' + a}),
        r.filename,
        !0
      ), this.processing (!1);
    },
    ...
    action: function (t, e, o, s) {
      ...
      function r (t, e) {
        ...
        ), o.attr ('count', parseFloat (o.attr ('count')) + 1), C (
          'row:eq(' + (t - 1) + ') c',
          u
        ).attr ('s', '51');
      }
      ...
      I.title && (n ([I.title]), r (y, i.header.length - 1)), I.messageTop &&
        (n ([I.messageTop]), r (y, i.header.length - 1)), s.header &&
        (n (i.header), C ('row:last c', u).attr ('s', '2'));
      for (var F = y, x = 0, h = i.body.length; x < h; x++)
        n (i.body[x]);
      (a = y), s.footer &&
        i.footer &&
        (n (i.footer), C ('row:last c', u).attr ('s', '2')), I.messageBottom &&
      ...
      C ('sheets sheet', w).attr ('name', N (s)), s.autoFilter &&
        ...
        )), s.customize && s.customize (p, s, e), 0 ===
        C ('mergeCells', u).children ().length && C ('mergeCells', u).remove ();
      var w = new (S ()) (),
        F = {
          compression: 'DEFLATE',
          type: 'blob',
        ...
        B = (!(function s (f, t) {
          D === k &&
            (D =
              ...
              ).indexOf ('xmlns:r')), C.each (t, function (t, e) {
      ...
      for (var d = 0, p = n.body.length; d < p; d++)
        a.push (
          C.map (n.body[d], function (t) {
            return {
              text: 'string' == typeof (t = null !== t && t !== k ? t : '')
                ? t
                : t + '',
