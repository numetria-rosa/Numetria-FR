...
!(function (e) {
  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof exports
        ? ((o = require ('jquery')), (i = function (t, n) {
            n.fn.dataTable || require ('datatables.net') (t, n);
          }), 'undefined' == typeof window
            ? (module.exports = function (t, n) {
                return (t = t || window), (n = n || o (t)), i (t, n), e (
                  n,
                  t,
                  t.document
                );
              })
            : (i (window, o), (module.exports = e (
                o,
                window,
                window.document
              ))))
  ...
  function B (n, t) {
    ...
    !0 === (t = void 0 === t ? {} : t) &&
      (t = {}), Array.isArray (t) && (t = {buttons: t}), (this.c = y.extend (!0, {}, B.defaults, t)), t.buttons && (this.c.buttons = t.buttons), (this.s = {dt: new e.Api (n), buttons: [], listenKeys: '', namespace: 'dtb' + o++}), (this.dom = {container: y ('<' + this.c.dom.container.tag + '/>').addClass (this.c.dom.container.className)}), this._constructor ();
  }
  y.extend (B.prototype, {
    ...
    active: function (t, n) {
      var t = this._nodeToButton (t),
        ...
        o = y (t.node);
      return t.inCollection &&
        this.c.dom.collection.button &&
        this.c.dom.collection.button.active !== w &&
        (e = this.c.dom.collection.button.active), n === w
        ? o.hasClass (e)
        : (o.toggleClass (e, n === w || n), this);
    },
    add: function (t, n, e) {
    ...
    collectionRebuild: function (t, n) {
      ...
      if (n !== w) {
        ...
        for (
          e.conf.prefixButtons && n.unshift.apply (n, e.conf.prefixButtons), e
            .conf.postfixButtons &&
            n.push.apply (n, e.conf.postfixButtons), (o = 0);
          o < n.length;
          o++
        ) {
          var i = n[o];
    ...
    enable: function (t, n) {
      return !1 === n
        ? this.disable (t)
        : ((n = this._nodeToButton (t)), y (n.node)
    ...
    processing: function (t, n) {
      ...
      return n === w
        ...
        : (y (o.node).toggleClass ('processing', n), y (
            e.table ().node ()
    ...
    remove: function (t) {
      ...
      (n.conf.destroying = !0), n.conf.destroy &&
        n.conf.destroy.call (o.button (t), o, y (t), n.conf), this._removeKey (
        n.conf
      ), y (n.node).remove ();
      o = y.inArray (n, e);
    ...
    _constructor: function () {
      ...
      t.on ('destroy', function (t, n) {
        ...
        (x.activeElement && x.activeElement !== x.body) ||
          ((n = String.fromCharCode (t.keyCode).toLowerCase ()), -1 !==
            e.s.listenKeys.toLowerCase ().indexOf (n) && e._keypress (n, t));
      });
    },
    _addKey: function (t) {
    ...
    _draw: function (t, n) {
      t ||
        ((t = this.dom.container), (n = this.s
          .buttons)), t.children ().detach ();
      for (var e = 0, o = n.length; e < o; e++)
        t.append (n[e].inserter), t.append (' '), n[e].buttons &&
          n[e].buttons.length &&
          ...
          if (((r = !(!p.config || !p.config.split)), Array.isArray (p)))
            ...
            if (h) {
              if (
                (s !== w && null !== s
                  ? (t.splice (s, 0, h), s++)
                  : t.push (h), h.conf.buttons &&
                  ((h.collection = y (
                    '<' + c.container.content.tag + '/>'
                  )), (h.conf._collection = h.collection), y (h.node).append (
                    c.action.dropHtml
                  ), this._expandButton (
                    h.buttons,
                    h.conf.buttons,
                ...
                for (var b = 0; b < h.conf.split.length; b++) {
                  ...
                  'object' == typeof g &&
                    ((g.parent = a), g.collectionLayout === w &&
                      (g.collectionLayout =
                        h.conf.collectionLayout), g.dropup === w &&
                      (g.dropup = h.conf.dropup), g.fade === w &&
                      (g.fade = h.conf.fade));
                }
                this._expandButton (
                  h.buttons,
              ...
              (h.conf.parent = a), p.init &&
                p.init.call (l.button (h.node), l, y (h.node), p);
            }
          }
      }
    },
    _buildButton: function (n, t, e, o) {
      ...
      if (
        (t && e && c.collection.split
          ...
          : o || t
              ...
              : e && y.extend (!0, d, c.split.button), n.spacer)
      )
        return (c = y ('<' + d.spacer.tag + '/>')
      ...
      n.hasOwnProperty ('html')
        ? (l = y (n.html))
        : ((a = function (t, n, e, o) {
            o.action.call (n.button (e), t, n, e, o), y (
              n.table ().node ()
            ).triggerHandler ('buttons-action.dt', [n.button (e), n, e, o]);
          }), (c = n.tag || d.tag), (r =
            n.clickBlurs === w || n.clickBlurs), (l = y ('<' + c + '/>')
            ...
            .on ('keypress.dtb', function (t) {
              13 === t.keyCode &&
                (t.preventDefault (), !l.hasClass (d.disabled) &&
                  n.action &&
                  a (t, u, l, n));
            })), 'a' === c.toLowerCase () && l.attr ('href', '#'), 'button' ===
            c.toLowerCase () && l.attr ('type', 'button'), (s = d.liner.tag
            ? ((c = y ('<' + d.liner.tag + '/>')
                .html (i (n.text))
                .addClass (d.liner.className)), 'a' ===
                d.liner.tag.toLowerCase () && c.attr ('href', '#'), l.append (
                c
              ), c)
            : (l.html (i (n.text)), l)), !1 === n.enabled &&
            l.addClass (d.disabled), n.className &&
            l.addClass (n.className), n.titleAttr &&
            l.attr ('title', i (n.titleAttr)), n.attr &&
            l.attr (n.attr), n.namespace ||
            (n.namespace = '.dt-button-' + C++), n.config !== w &&
            n.config.split &&
      ...
      var f,
        ...
        c = c && c.tag
          ? y ('<' + c.tag + '/>').addClass (c.className).append (l)
          : l;
      return this._addKey (n), this.c.buttonCreated &&
        (c = this.c.buttonCreated (n, c)), e &&
        ((p = (f = t
          ? y.extend (!0, this.c.dom.split, this.c.dom.collection.split)
          : this.c.dom.split).wrapper), (h = y ('<' + p.tag + '/>')
          .addClass (p.className)
          .append (l)), (b = y.extend (n, {
          ...
          _.split.action.call (n.button (h), t, n, e, o), y (
            n.table ().node ()
          ...
          })), 0 === n.split.length && m.addClass ('dtb-hide-drop'), h
          .append (m)
          .attr (b.attr)), {
        conf: n,
        node: (e ? h : l).get (0),
        ...
        (r = function (t) {
          for (var n, e, o = 0, i = t.length; o < i; o++)
            (n = t[o].conf), (e = t[o].node), !n.key ||
              ...
              ((a._buttonsHandled = !0), y (e).click ()), t[o].buttons.length &&
              r (t[o].buttons);
        }) (this.s.buttons);
    },
    _removeKey: function (t) {
      var n;
      t.key &&
        ((t = (y.isPlainObject (t.key) ? t.key : t)
          .key), (n = this.s.listenKeys.split ('')), (t = y.inArray (
          t,
          n
        )), n.splice (t, 1), (this.s.listenKeys = n.join ('')));
    },
    _resolveExtends: function (e) {
      ...
      for (e = t (e); e && e.extend; ) {
        ...
        e.config !== w &&
          a.config !== w &&
          (e.config = y.extend ({}, a.config, e.config)), (e = y.extend (
          {},
          a,
          e
        )), r &&
          e.className !== r &&
          (e.className = r + ' ' + e.className), (e.extend = a.extend);
      }
    ...
    _popover: function (o, t, n, e) {
      function i () {
        ...
        ).attr ('aria-expanded', 'false'), y ('div.dt-button-background').off (
          'click.dtb-collection'
        ), B.background (!1, b.backgroundClassName, b.fade, m), y (v).off (
          'resize.resize.dtb-collection'
        ), y ('body').off ('.dtb-collection'), f.off (
      ...
      !1 === o
        ...
        : ((p = y (
            f
              ...
              .nodes ()
          )).length && (m.closest (g).length && (m = p.eq (0)), i ()), (n = y (
            '.dt-button',
            o
          ).length), (p = ''), 3 === n
            ? (p = 'dtb-b3')
            : 2 === n ? (p = 'dtb-b2') : 1 === n && (p = 'dtb-b1'), (s = y (
            '<' + b.tag + '/>'
          )
            ...
            .addClass (p)
            .css ('display', 'none')
            .attr ({'aria-modal': !0, role: 'dialog'})), (o = y (o)
            .addClass (b.contentClassName)
            .attr ('role', 'menu')
            .appendTo (s)), m.attr ('aria-expanded', 'true'), m.parents (
            'body'
          )[0] !== x.body && (m = x.body.lastChild), b.popoverTitle
            ? s.prepend (
            ...
            s
              ...
              .addClass ('dtb-collection-closeable'), A (
            s.insertAfter (m),
            b.fade
          ), (n = y (t.table ().container ())), (d = s.css (
            'position'
          )), ('container' !== b.span && 'dt-container' !== b.align) ||
            ((m = m.parent ()), s.css ('width', n.width ())), 'absolute' === d
            ? ((p = y (
                m[0].offsetParent
              )), (t = m.position ()), (n = m.offset ()), (a = p.offset ()), (r = p.position ()), (l = v.getComputedStyle (
                p[0]
              )), (a.height = p.outerHeight ()), (a.width =
                p.width () + parseFloat (l.paddingLeft)), (a.right =
                a.left + a.width), (a.bottom = a.top + a.height), (p =
                t.top + m.outerHeight ()), (c = t.left), s.css ({
                top: p,
                left: c,
              }), (l = v.getComputedStyle (
                s[0]
              )), ((u = s.offset ()).height = s.outerHeight ()), (u.width = s.outerWidth ()), (u.right =
                u.left + u.width), (u.bottom =
                u.top + u.height), (u.marginTop = parseFloat (
                l.marginTop
              )), (u.marginBottom = parseFloat (l.marginBottom)), b.dropup &&
                (p =
                  t.top -
                  u.height -
                  u.marginTop -
                  u.marginBottom), ('button-right' !== b.align &&
                !s.hasClass (b.rightAlignClassName)) ||
                (c = t.left - u.width + m.outerWidth ()), ('dt-container' !==
                b.align &&
                'container' !== b.align) ||
                ((c = c < t.left ? -t.left : c) + u.width > a.width &&
                  (c = a.width - u.width)), r.left + c + u.width >
                y (v).width () &&
                (c = y (v).width () - u.width - r.left), n.left + c < 0 &&
                (c = -n.left), r.top + p + u.height >
                y (v).height () + y (v).scrollTop () &&
                (p = t.top - u.height - u.marginTop - u.marginBottom), r.top +
                p <
                y (v).scrollTop () && (p = t.top + m.outerHeight ()), s.css ({
                top: p,
                left: c,
              }))
            : ((d = function () {
          ...
          ).on ('click.dtb-collection', function () {}), b.autoClose &&
            setTimeout (function () {
              f.on ('buttons-action.b-internal', function (t, n, e, o) {
                o[0] !== m[0] && i ();
              });
            }, 0), y (s).trigger ('buttons-popover.dt'), f.on (
            'destroy',
            i
          ), setTimeout (function () {
            (h = !1), y ('body')
              .on ('click.dtb-collection', function (t) {
                var n, e;
                h ||
                  ((n = y.fn.addBack ? 'addBack' : 'andSelf'), (e = y (
                    t.target
                  ).parent ()[0]), ((y (t.target).parents ()[n] ().filter (o)
                    .length ||
      ...
      var c = [],
        ...
        d = function (t, n) {
          ...
          if (Array.isArray (t) || t instanceof y)
            ...
            'object' != typeof t ||
              !t.nodeName ||
              (-1 !== (r = y.inArray (t, o)) && c.push ({inst: n, node: o[r]}));
        },
        e = 0,
        o = t.length;
      e < o;
    ...
    return 'string' == typeof t &&
      ((t = (t = t.replace (
        ...
        ''
      )).replace (/<!\-\-.*?\-\->/g, '')), (n && !n.stripHtml) ||
        (t = t.replace (/<[^>]*>/g, '')), (n && !n.trim) ||
        (t = t.replace (/^\s+|\s+$/g, '')), (n && !n.stripNewlines) ||
        (t = t.replace (/\n/g, ' ')), (n && !n.decodeEntities) ||
        (t = i ? i (t) : ((c.innerHTML = t), c.value))), t;
  }), (B.entityDecoder = function (t) {
    i = t;
  }), (B.defaults = {buttons: ['copy', 'excel', 'csv', 'pdf', 'print'], name: 'main', tabIndex: 0, dom: {container: {tag: 'div', className: 'dt-buttons'}, collection: {action: {dropHtml: '<span class="dt-button-down-arrow">&#x25BC;</span>'}, container: {className: 'dt-button-collection', content: {className: '', tag: 'div'}, tag: 'div'}}, button: {tag: 'button', className: 'dt-button', active: 'dt-button-active', disabled: 'disabled', spacer: {className: 'dt-button-spacer', tag: 'span'}, liner: {tag: 'span', className: ''}}, split: {action: {className: 'dt-button-split-drop-button dt-button', tag: 'button'}, dropdown: {align: 'split-right', className: 'dt-button-split-drop', dropHtml: '<span class="dt-button-down-arrow">&#x25BC;</span>', splitAlignClass: 'dt-button-split-left', tag: 'button'}, wrapper: {className: 'dt-button-split', tag: 'div'}}}}), y.extend (
    _,
    {
      collection: {
        text: function (t) {
        ...
        action: function (t, n, e, o) {
          o._collection.parents ('body').length
            ? this.popover (!1, o)
            : this.popover (o._collection, o), 'keypress' === t.type &&
    ...
    return o.length &&
      ...
      o[0].add (n, t, e), this.button (this._groupSelector, t);
    ...
    var o = this;
    return !1 === t
      ? (this.off ('destroy.btn-info'), k (
          y ('#datatables_buttons_info'),
          400,
          function () {
            y (this).remove ();
          }
        ), clearTimeout (s), (s = null))
      : (s && clearTimeout (s), y ('#datatables_buttons_info').length &&
          y ('#datatables_buttons_info').remove (), (t = t
          ? '<h2>' + t + '</h2>'
          : ''), A (
  ...
  var s,
    ...
    l = function (t, n, e) {
      ...
      return null === n
        ? null
        : ((t = y ('caption', t.table ().container ()).eq (0)), '*' === n
            ? t.css ('caption-side') !== e ? null : t.length ? t.text () : ''
            : n);
    },
    c = y ('<textarea/>')[0],
    u = function (e, t) {
  ...
  return (y.fn.dataTable.Buttons = B), (y.fn.DataTable.Buttons = B), y (
    x
  ).on ('init.dt plugin-init.dt', function (t, n) {
    'dt' === t.namespace &&
