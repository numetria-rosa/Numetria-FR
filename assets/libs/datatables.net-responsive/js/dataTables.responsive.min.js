...
!(function (n) {
  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof exports
        ? ((i = require ('jquery')), (r = function (e, t) {
            t.fn.dataTable || require ('datatables.net') (e, t);
          }), 'undefined' == typeof window
            ? (module.exports = function (e, t) {
                return (e = e || window), (t = t || i (e)), r (e, t), n (
                  t,
                  e,
                  e.document
                );
              })
            : (r (window, i), (module.exports = n (
                i,
                window,
                window.document
              ))))
    ...
    e = (f.extend (a.prototype, {
      _constructor: function () {
        var s = this,
          ...
          e = i.settings ()[0],
          t = f (m).innerWidth (),
          e = ((i.settings ()[0]._responsive = this), f (m).on (
            'resize.dtr orientationchange.dtr',
            r.util.throttle (function () {
              var e = f (m).innerWidth ();
              e !== t && (s._resize (), (t = e));
            })
          ), e.oApi._fnCallbackReg (e, 'aoRowCreatedCallback', function (
            e,
            t,
            n
          ) {
            ...
            i.off (
              '.dtr'
            ), f (i.table ().body ()).off ('.dtr'), f (m).off ('resize.dtr orientationchange.dtr'), i.cells ('.dtr-control').nodes ().to$ ().removeClass ('dtr-control'), f.each (
              s.s.current,
              function (e, t) {
        ...
        !1 !== e.type &&
          (s._detailsInit (), i.on ('column-visibility.dtr', function () {
            s._timer &&
              clearTimeout (s._timer), (s._timer = setTimeout (function () {
        ...
        var a = this,
          ...
          c = i.columns ().eq (0).map (function (e) {
            ...
            return e === h &&
              (e = t === h || null === t
                ? 1e4
                : +t), {className: n, includeIn: [], auto: !1, control: !1, never: !!n.match (/\b(dtr\-)?never\b/), priority: e};
          }),
          u = function (e, t) {
            e = c[e].includeIn;
      ...
      _controlClass: function () {
        ...
        'inline' === this.c.details.type &&
          ((e = this.s.dt), (t = this.s.current), (n = f.inArray (!0, t)), e
            .cells (
              null,
              function (e) {
                return e !== n;
      ...
      _detailsDisplay: function (t, n) {
        function e (e) {
          f (t.node ()).toggleClass ('parent', !1 !== e), f (
            s.table ().node ()
          ).triggerHandler ('responsive-display.dt', [s, t, e, n]);
        }
        var i, r = this, s = this.s.dt, o = this.c.details;
        o &&
          !1 !== o.type &&
          ((i = 'string' == typeof o.renderer
      ...
      _detailsInit: function () {
        var n = this,
          ...
          r = ('inline' === e.type &&
            (e.target =
              'td.dtr-control, th.dtr-control'), i.on ('draw.dtr', function () {
            n._tabIndexes ();
          }), n._tabIndexes (), f (
            i.table ().body ()
        ...
        (r === h && null === r) ||
          f (
            i.table ().body ()
          ).on ('click.dtr mousedown.dtr mouseup.dtr', e, function (e) {
            if (
      ...
      _resize: function (n) {
        ...
        t.columns ().eq (0).each (function (e, t) {
          !0 === c[t] &&
            p++, (!n && c[t] === a[t]) || ((h = !0), i._setColumnVis (e, c[t]));
        }), this._redrawChildren (), h &&
          (f (t.table ().node ()).trigger ('responsive-resize.dt', [
            ...
            f ('td', t.table ().body ())
              .eq (0)
              .attr ('colspan', p)), i._controlClass ();
      },
      _resizeAuto: function () {
        ...
        this.c.auto &&
          ...
          (f.isEmptyObject (this.s.childNodeStore) ||
            ...
            .offsetWidth, s.columns, (e = s
            .table ()
            .node ()
            .cloneNode (!1)), (t = f (
            s.table ().header ().cloneNode (!1)
          ).appendTo (e)), (i = f (s.table ().body ())
            .clone (!1, !1)
            .empty ()
            .appendTo (e)), (e.style.width = 'auto'), (n = s
            .columns ()
            .header ()
            .filter (function (e) {
            ...
            .find ('th, td')
            .css ('display', ''), (i = s.table ().footer ()) &&
            ((i = f (i.cloneNode (!1)).appendTo (e)), (r = s
              .columns ()
              .footer ()
              .filter (function (e) {
                return s.column (e).visible ();
              ...
              .to$ ()
              .clone (!1)
              .css ('display', 'table-cell')), f ('<tr/>')
              .append (r)
              .appendTo (i)), f ('<tr/>').append (n).appendTo (t), 'inline' ===
            this.c.details.type && f (e).addClass ('dtr-inline collapsed'), f (
            e
          )
            .find ('[name]')
            .removeAttr ('name'), f (e).css ('position', 'relative'), (r = f (
            '<div/>'
          )
            .css ({width: 1, height: 1, overflow: 'hidden', clear: 'both'})
            .append (e)).insertBefore (s.table ().node ()), n.each (function (
            e
          ) {
      ...
      _setColumnVis: function (e, t) {
        ...
        f (i.column (e).header ())
          .css ('display', r)
          .toggleClass ('dtr-hidden', !t), f (i.column (e).footer ())
          .css ('display', r)
          .toggleClass ('dtr-hidden', !t), i
          .column (e)
          .nodes ()
          .to$ ()
          .css ('display', r)
          .toggleClass ('dtr-hidden', !t), f.isEmptyObject (
          this.s.childNodeStore
        ) ||
          i.cells (null, e).indexes ().each (function (e) {
      ...
      _tabIndexes: function () {
        ...
        t
          ...
          .removeData ('[data-dtr-keyboard]'), ('number' == typeof i
          ? e.cells (null, i, {page: 'current'}).nodes ().to$ ()
          : f (
              (i = 'td:first-child, th:first-child' === i
          ...
          modal: function (o) {
            return function (e, t, n, i) {
              if (t) {
                ...
                var r = function () {
                  s.remove (), f (d).off ('keypress.dtr'), f (
                    e.node ()
                  ).removeClass ('parent'), i ();
                },
          ...
          listHiddenNodes: function () {
            return function (i, e, t) {
              ...
              f.each (t, function (e, t) {
                var n;
                t.hidden &&
                  ((n = t.className ? 'class="' + t.className + '"' : ''), f (
                    '<li ' +
                      n +
                      ' data-dtr-index="' +
                      t.columnIndex +
          ...
          tableAll: function (i) {
            return (i = f.extend ({tableClass: ''}, i)), function (e, t, n) {
              n = f
                ...
                .join ('');
              return f (
                '<table class="' + i.tableClass + ' dtr-details" width="100%"/>'
              ).append (n);
            };
          },
        }).listHidden (),
  ...
  ), (a.version = '2.5.0'), (f.fn.dataTable.Responsive = a), (f.fn.DataTable.Responsive = a), f (
    d
  ).on ('preInit.dt.dtr', function (e, t, n) {
    'dt' === e.namespace &&
